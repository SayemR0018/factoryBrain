...
export const en = {
  ...
  overview: {
    ...
    lineBoard: "Live line board",
    lineBoardSubtitle: "Six lines, derived from sensor sim. Updates on each Simulate tick.",
    colLine: "Line",
    colBottleneck: "Bottleneck",
    colEff: "Eff",
    colSah: "SAH",
    colWip: "WIP",
    colNpt: "NPT (min)",
    bottleneckGreen: "On target",
    bottleneckAmber: "Watch",
    bottleneckRed: "Critical",
    effShort: "{eff}% of target {target}%",
  ...
  settings: {
    ...
    agentsRisk: "Agents & risk",
    dataReset: "Data reset",
    dataResetBody: "Wipe everything saved in this browser. The simulated-data label is preserved on every source row; a saved LLM key is preserved in .env.local (clear it from the Advanced tab).",
    resetDemo: "Reset demo",
    resetDemoHint: "Removes profile, thresholds, integrations, theme and saved views from this browser.",
