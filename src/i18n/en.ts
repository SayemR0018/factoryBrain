...
export const en = {
  ...
  qc: {
    ...
    pageSubtitle: "Eight weeks of defect and rework rates per operation × line. Flag an issue to push it into Insights.",
    simulatedChip: "Demo · no LLM",
    refreshAria: "Refresh QC defects",
    retry: "Retry",
    loadFailed: "Couldn't load QC defects.",
    loadFailedBody: "The deterministic QC seed didn't return data. Try refreshing.",
    sortDefect: "By defect",
    sortRework: "By rework",
    sortBy: "Sort",
    openFull: "Open full grid",
    sourceHint: "Source: Bosch-shaped taxonomy (cutting / sewing / buttonhole / top_stitch / qc_inspection / finishing).",
    flagIssue: "Flag issue",
    flagToastTitle: "QC issue flagged",
    flagToastHref: "Open in Insights →",
    flagFailedTitle: "Couldn't flag the issue",
    defectPct: "Defect {pct}%",
    reworkPct: "Rework {pct}%",
    trendHigh: "Above target",
    trendWatch: "Watch trend",
    trendLow: "On target",
    rateAria: "{op} on {line}: {rate} percent",
    flagAria: "Flag issue for {op} on {line}",
    subtitle: "{weeks} weeks · latest Monday first",
    topDefect: "Top 5 by defect rate",
    topDefectSubtitle: "Sorted by % defects ÷ inspected across the eight weeks.",
    topRework: "Top 5 by rework rate",
    topReworkSubtitle: "Sorted by % rework ÷ inspected across the eight weeks.",
    fullGrid: "Full operations grid",
    fullGridSubtitle: "All 36 (operation × line) cells, sorted by your selection.",
    colOp: "Operation",
    colLine: "Line",
